...
\begin{choices}
  ...
  \choice {\tt class Dog extends Mammal implements Pet, Canine}
...
\question[1]{Fill in the table for the width of each integer type in both bits and bytes. \\}
...
\question[1]{Given array $A = [3, 9, 2, 9, 0, 10, 1]$,}
...
% debugging
\begin{minipage}{\textwidth}
\question[1]{Highlight the error(s) in the following code segment, and explain both (a) why they are errors and (b) what type of error they are.}
